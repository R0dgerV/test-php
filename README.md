...
* Рубрики газеты
* Конкретные статьи, которые принадлежат к какой-то рубрике (одна статья может принадлежать к нескольким рубрикам), ЧПУ должен присутсвовать.
* Пользователей, которые могут авторизоваться

Возможные действия:
* Получение списка всех рубрик
* Получение списка статей в конкретной рубрике
* Авторизация пользователей
* Добавление/Редактирование/Удаление рубрики (для авторизованных пользователей)
* Добавление/Редактирование/Удаление статьи (для авторизованных пользователей)
* Создать метод, при вызове которого можно получить только статьи, которые изменены за последние 1 минуту, 10 минут, n Минут.
...
* Framework – предпочтительно Laravel/Lumen или без framework’ов; 
* Можно использовать composer;
* Должны быть unit тесты;
* В проекте должны быть тесты, которые проверяют REST API;
...
* Как плюс, ссылка на работающий пример, API only
...
### C13. Бизнес-логика в классах Eloquent

| Описание  | Балл |
| --------- | ----:|
| бизнес логика написана в классе Eloquent | 0 |
| бизнес логика вынесена из классов Eloquent | 2 |
